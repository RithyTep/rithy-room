...
const GAMES_CATALOG: GameItem[] = [
  ...
  { id: 'spyro-dragon', name: 'Spyro the Dragon', description: '3D platformer adventure with the purple dragon', thumbnail: '/images/games/ps1/spyro-the-dragon.jpg', url: 'https://www.retrogames.cc/psx-games/spyro-the-dragon.html', maxPlayers: '1', category: 'ps1', tags: ['platformer', 'spyro', 'playstation', 'popular'] },
  ...
  { id: 'metal-gear-solid', name: 'Metal Gear Solid', description: 'Stealth action - Solid Snake infiltrates', thumbnail: '/images/games/ps1/metal-gear-solid.jpg', url: 'https://www.retrogames.cc/psx-games/metal-gear-solid-disc-1.html', maxPlayers: '1', category: 'ps1', tags: ['stealth', 'action', 'konami', 'popular'] },
  { id: 'resident-evil', name: 'Resident Evil', description: 'Survival horror classic - Escape the mansion', thumbnail: '/images/games/ps1/resident-evil.jpg', url: 'https://www.retrogames.cc/psx-games/resident-evil.html', maxPlayers: '1', category: 'ps1', tags: ['horror', 'survival', 'capcom'] },
  { id: 'gran-turismo', name: 'Gran Turismo', description: 'The real driving simulator', thumbnail: '/images/games/ps1/gran-turismo.jpg', url: 'https://www.retrogames.cc/psx-games/gran-turismo.html', maxPlayers: '2', category: 'ps1', tags: ['racing', 'simulator', 'cars'] },
  { id: 'tony-hawk-2', name: "Tony Hawk's Pro Skater 2", description: 'Skateboarding classic - nail those combos', thumbnail: '/images/games/ps1/tony-hawk-2.jpg', url: 'https://www.retrogames.cc/psx-games/tony-hawks-pro-skater-2.html', maxPlayers: '2', category: 'ps1', tags: ['sports', 'skateboard', 'popular'] },
  { id: 'castlevania-sotn', name: 'Castlevania: SOTN', description: 'Symphony of the Night - Explore Draculas castle', thumbnail: '/images/games/ps1/castlevania-sotn.jpg', url: 'https://www.retrogames.cc/psx-games/castlevania-symphony-of-the-night.html', maxPlayers: '1', category: 'ps1', tags: ['action', 'metroidvania', 'konami', 'popular'] },
  { id: 'crash-team-racing', name: 'Crash Team Racing', description: 'Kart racing with Crash characters', thumbnail: '/images/games/ps1/crash-team-racing.jpg', url: 'https://www.retrogames.cc/psx-games/crash-team-racing.html', maxPlayers: '4', category: 'ps1', tags: ['racing', 'crash', 'multiplayer'] },
  { id: 'crash-bandicoot-2', name: 'Crash Bandicoot 2', description: 'Cortex Strikes Back - more platforming fun', thumbnail: '/images/games/ps1/crash-bandicoot-2.jpg', url: 'https://www.retrogames.cc/psx-games/crash-bandicoot-2-cortex-strikes-back.html', maxPlayers: '1', category: 'ps1', tags: ['platformer', 'crash', 'popular'] },
  { id: 'crash-bandicoot-3', name: 'Crash Bandicoot 3: Warped', description: 'Time-traveling platformer adventure', thumbnail: '/images/games/ps1/crash-bandicoot-3.jpg', url: 'https://www.retrogames.cc/psx-games/crash-bandicoot-warped.html', maxPlayers: '1', category: 'ps1', tags: ['platformer', 'crash', 'popular'] },
  { id: 'spyro-2', name: 'Spyro 2: Riptos Rage', description: 'Dragon adventure continues', thumbnail: '/images/games/ps1/spyro-2.jpg', url: 'https://www.retrogames.cc/psx-games/spyro-2-riptos-rage.html', maxPlayers: '1', category: 'ps1', tags: ['platformer', 'spyro', 'popular'] },
  { id: 'resident-evil-2', name: 'Resident Evil 2', description: 'Survival horror in Raccoon City', thumbnail: '/images/games/ps1/resident-evil-2.jpg', url: 'https://www.retrogames.cc/psx-games/resident-evil-2-dual-shock-ver-disc-1-leon.html', maxPlayers: '1', category: 'ps1', tags: ['horror', 'survival', 'capcom', 'popular'] },
  { id: 'twisted-metal-2', name: 'Twisted Metal 2', description: 'Vehicular combat destruction', thumbnail: '/images/games/ps1/twisted-metal-2.jpg', url: 'https://www.retrogames.cc/psx-games/twisted-metal-2.html', maxPlayers: '2', category: 'ps1', tags: ['action', 'vehicles', 'multiplayer'] },
  { id: 'ape-escape', name: 'Ape Escape', description: 'Catch monkeys with gadgets', thumbnail: '/images/games/ps1/ape-escape.jpg', url: 'https://www.retrogames.cc/psx-games/ape-escape.html', maxPlayers: '1', category: 'ps1', tags: ['platformer', 'action', 'sony'] },
  { id: 'medievil', name: 'MediEvil', description: 'Undead knight adventure', thumbnail: '/images/games/ps1/medievil.jpg', url: 'https://www.retrogames.cc/psx-games/medievil.html', maxPlayers: '1', category: 'ps1', tags: ['action', 'adventure', 'horror'] },
  { id: 'silent-hill', name: 'Silent Hill', description: 'Psychological horror classic', thumbnail: '/images/games/ps1/silent-hill.jpg', url: 'https://www.retrogames.cc/psx-games/silent-hill.html', maxPlayers: '1', category: 'ps1', tags: ['horror', 'survival', 'konami', 'popular'] },
  { id: 'tomb-raider', name: 'Tomb Raider', description: 'Lara Croft adventure begins', thumbnail: '/images/games/ps1/tomb-raider.jpg', url: 'https://www.retrogames.cc/psx-games/tomb-raider.html', maxPlayers: '1', category: 'ps1', tags: ['action', 'adventure', 'popular'] },
  ...
  { id: 'parappa-rapper', name: 'PaRappa the Rapper', description: 'Kick punch its all in the mind', thumbnail: '/images/games/ps1/parappa-rapper.jpg', url: 'https://www.retrogames.cc/psx-games/parappa-the-rapper.html', maxPlayers: '1', category: 'ps1', tags: ['rhythm', 'music', 'unique'] },
  { id: 'syphon-filter', name: 'Syphon Filter', description: 'Third-person stealth action', thumbnail: '/images/games/ps1/syphon-filter.jpg', url: 'https://www.retrogames.cc/psx-games/syphon-filter.html', maxPlayers: '1', category: 'ps1', tags: ['action', 'stealth', 'shooter'] },
  { id: 'dino-crisis', name: 'Dino Crisis', description: 'Resident Evil with dinosaurs', thumbnail: '/images/games/ps1/dino-crisis.jpg', url: 'https://www.retrogames.cc/psx-games/dino-crisis.html', maxPlayers: '1', category: 'ps1', tags: ['horror', 'survival', 'capcom'] },
  { id: 'vagrant-story', name: 'Vagrant Story', description: 'Dark action RPG', thumbnail: '/images/games/ps1/vagrant-story.jpg', url: 'https://www.retrogames.cc/psx-games/vagrant-story.html', maxPlayers: '1', category: 'ps1', tags: ['rpg', 'action', 'squaresoft'] },
];
